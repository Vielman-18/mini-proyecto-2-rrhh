...
var EmpleadosController = function () {
    var _classDecorators = [(0, common_1.Controller)('empleados')];
    ...
    var EmpleadosController = _classThis = /** @class */ (function () {
        function EmpleadosController_1(empleadosService) {
            this.empleadosService = (__runInitializers(this, _instanceExtraInitializers), empleadosService);
        }
        EmpleadosController_1.prototype.listar = function () {
            return this.empleadosService.listarEmpleados();
        };
        EmpleadosController_1.prototype.crear = function (nombre, salarioBase) {
            return this.empleadosService.crearEmpleado(nombre, salarioBase);
        };
        return EmpleadosController_1;
    }());
    __setFunctionName(_classThis, "EmpleadosController");
    (function () {
        ...
        EmpleadosController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EmpleadosController = _classThis;
}();
